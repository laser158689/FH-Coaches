# field-hockey-coaching - claude-code

This directory is the generated target-specific view of the family.

Artifact contract: Local Claude Code skill bundle for filesystem install.
...
- `family.skill` is the aggregated family reference text.
- `*.skill` files are the per-skill Claude Code bundle text.
