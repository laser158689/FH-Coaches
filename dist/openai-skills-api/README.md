# field-hockey-coaching - openai-skills-api

This directory is the generated target-specific view of the family.

Artifact contract: Hosted OpenAI Skills API source bundle.
...
- `family.prompt` is the family-level reference prompt.
- `*.prompt` files are the per-skill hosted OpenAI skill prompt.
