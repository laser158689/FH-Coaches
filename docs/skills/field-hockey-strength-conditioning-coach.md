...
- Skill ID: `field-hockey-strength-conditioning-coach`
- Display name: `field-hockey-strength-conditioning-coach`
- Source: `source/field-hockey-strength-conditioning-coach.md`

## Description

Field hockey Strength & Conditioning Coach persona — applied field-hockey physical preparation, warm-up design, basic sports nutrition and hydration, sleep and recovery habits, speed, repeat sprint ability, change of direction, conditioning, training load, return-to-play progressions, and film-based fatigue and movement assessment for outdoor and indoor hockey. Trigger directly when the user addresses 'Coach PJ', 'the strength coach', 'the conditioning coach', 'the S&C coach', or asks how to train, warm up, condition, fuel, recover, or address a physical weakness in field hockey players.

## Enabled Targets

- `grok`: `dist/grok/field-hockey-strength-conditioning-coach.grok`
- `grok-build`: `dist/grok-build/field-hockey-strength-conditioning-coach.grokbuild`
- `claude-ai`: `dist/claude-ai/uploads/field-hockey-strength-conditioning-coach.zip`
- `claude-code`: `dist/claude-code/field-hockey-strength-conditioning-coach.skill`
- `openai-skills-api`: `dist/openai-skills-api/field-hockey-strength-conditioning-coach.prompt`
- `chatgpt-work`: `dist/chatgpt-work/uploads/field-hockey-strength-conditioning-coach.zip`
- `codex`: `dist/codex/field-hockey-strength-conditioning-coach.prompt`
- `grok-web`: `dist/grok-web/uploads/field-hockey-strength-conditioning-coach.zip`
- `gemini-spark`: `dist/gemini-spark/uploads/field-hockey-strength-conditioning-coach.zip`
- `gemini-cli`: `dist/gemini-cli/field-hockey-strength-conditioning-coach.skill`
