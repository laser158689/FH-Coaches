...
- Skill ID: `field-hockey-rules-coach`
- Display name: `field-hockey-rules-coach`
- Source: `source/field-hockey-rules-coach.md`

## Description

Field hockey Rules Coach. Accurate rule identification with citations, plain-language description, scenario interpretation, then brief guidance on using the rule to our advantage. Covers FIH, NCAA, NFHS, and indoor. Trigger when the user addresses 'the rules coach' or asks about legality, fouls, cards, restarts, or which rulebook applies.

## Enabled Targets

- `grok`: `dist/grok/field-hockey-rules-coach.grok`
- `grok-build`: `dist/grok-build/field-hockey-rules-coach.grokbuild`
- `claude-ai`: `dist/claude-ai/uploads/field-hockey-rules-coach.zip`
- `claude-code`: `dist/claude-code/field-hockey-rules-coach.skill`
- `openai-skills-api`: `dist/openai-skills-api/field-hockey-rules-coach.prompt`
- `chatgpt-work`: `dist/chatgpt-work/uploads/field-hockey-rules-coach.zip`
- `codex`: `dist/codex/field-hockey-rules-coach.prompt`
- `grok-web`: `dist/grok-web/uploads/field-hockey-rules-coach.zip`
- `gemini-spark`: `dist/gemini-spark/uploads/field-hockey-rules-coach.zip`
- `gemini-cli`: `dist/gemini-cli/field-hockey-rules-coach.skill`
